...
import static io.iexec.common.chain.ChainContributionStatus.CONTRIBUTED;
import static io.iexec.common.chain.ChainContributionStatus.REVEALED;
import static io.iexec.common.contract.generated.IexecHubContract.*;
...
import io.iexec.common.task.TaskDescription;
import io.iexec.common.tee.TeeUtils;
import io.iexec.common.utils.BytesUtils;
import io.iexec.common.utils.MultiAddressHelper;

import io.iexec.common.contract.generated.App;
import io.iexec.common.contract.generated.Ownable;
    ...
    public Optional<ChainDeal> getChainDeal(String chainDealId) {
        ...
        try {
            ...
            return Optional.of(ChainDeal.builder()
                    ...
                    .params(ChainDeal.stringToDealParams(dealPt2.getValue6()))
